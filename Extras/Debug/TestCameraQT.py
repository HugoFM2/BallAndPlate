...
IMG_SIZE    = 320,240          # 640,480 or 1280,720 or 1920,1080
    ...
    while capturing:
        if cap.grab():
            ...
            if image is not None and queue.qsize() < 2:
                gaussian_blurr = cv2.GaussianBlur(image.copy(), (3,3), cv2.BORDER_DEFAULT) # Aplicando para reduzir noise and outliers
                hsv = cv2.cvtColor(gaussian_blurr, cv2.COLOR_BGR2HSV) # Aplica filtro HSV para detectar a bolinha
